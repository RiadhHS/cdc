                        ...
                        <div class="container mx-auto px-4 py-8">
                            ...
                            <div class="flex items-center mb-4">
                              ...
                              <div class="flex items-center mb-4">
                                <input type="checkbox" id="terms" name="terms" class="w-5 h-5 accent-primary focus:ring-primary focus:ring-offset-white">
                                <label for="terms" class="ml-2 text-sm text-gray-700">
                                    Je souhaiterais l’inscription à l'ordre du jour de la prochaine assemblée générale les questions suivantes :
                                </label>
                              </div>

                              <div class="flex items-center mb-4">
                                <label for="terms" class="ml-2 text-sm text-gray-700 pr-10">
                                    Question1: 
                                </label>
    
                                <textarea id="message" name="message" class=" w-1/4 h-16 resize-none rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-blue-500 focus:border-blue-500"></textarea>
                              </div>
                              <div class="flex items-center mb-4">
                                <label for="terms" class="ml-2 text-sm text-gray-700 pr-10">
                                    Question2: 
